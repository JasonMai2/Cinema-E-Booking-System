...
public class Booking {
    ...
    public Booking(Long id, String bookingNumber, Long userId, String status,
                   Integer subtotalCents, Integer feesCents, Integer taxCents,
                   Integer totalCents, Long promoCodeId, LocalDateTime createdAt) {
        this.id = id;
    ...
    public Integer getFeesCents() {
        return feesCents;
    }

    public void setFeesCents(Integer feesCents) {
        this.feesCents = feesCents;
    }
